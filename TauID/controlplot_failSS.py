...
MCfileList = ["DYJ", "DYB", "VV", "W", "TT", "DYS"]
MClabel = ["Z(ll)Jets", "Z(ll)", "VV", "WJets", "TTJets", "Z(#tau#tau)"]
...
label3 = ROOT.TLatex(0.55,0.86, "failSS")
label1.SetNDC()
label2.SetNDC()
...
data = fData.Get("failSS/data_obs")
data.Sumw2()
data.SetStats(0)
...
pad2.cd()
ratio.Draw("EP")
canvas.SaveAs("tauvismass_failSS.pdf")
